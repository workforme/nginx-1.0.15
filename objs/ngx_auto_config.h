#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-pcre=/home/yilong/sources/pcre-8.31/ --with-http_stub_status_module --with-http_ssl_module --with-openssl=../sources/openssl-1.0.1j"
